...
**data quality changes**, **SHAP feature impact**, and **incident summaries** across simulated production batches.
"""
)
...
# User can choose one production batch to inspect deeply
...
# User can control how many SHAP features to display
...
# Optional checkbox to show full technical tables
...
# ---------------------------------------------------------
# Visual comparison across batches
# ---------------------------------------------------------
...
# Chart 1: prediction risk vs baseline risk across batches
...
# Chart 2: feature drift score across batches
fig_drift = px.bar(
    monitoring_df,
    x="batch_name",
...
st.caption(
    "Built with Python, SQL-style batch data, pandas, scikit-learn, XGBoost, SHAP, MLflow outputs, Streamlit, and Plotly."
)